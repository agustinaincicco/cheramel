...
<div class="preguntas">
    <div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <br><br>
        <p>
        Todos los productos se encuentran realizados en forma artesanal prestando especial cuidado a todos los detalles del proceso productivo. Cheramel también ofrece el servicio de ambientación a domicilio, el cual busca crear ambientes únicos con muebles y accesorios que den personalidad y rescaten la esencia de cada espacio.
        </p>
    </div>
</div>
<hr>
